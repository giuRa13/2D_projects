AssetDefs =
{
    ...
    sound_fx =
    {
        {name = "asteroid_explosion", path = "assets/ASTEROIDS/sounds/sound/asteroid_explosion.wav"},
        {name = "ship_explosion", path = "assets/ASTEROIDS/sounds/sound/ship_explosion.wav"},
