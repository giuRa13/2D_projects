        ...
        function(entity_a)
            ...
            entities:for_each(
                function(entity_b)
                    ...
                    local group_b = entity_b:group() -- asteroids No collide each other
...
function CollisionSystem:Intersect(entity_a, entity_b)
    ...
    local distanceSq = difference:lenghtSq()

    -- get circle collider for the radius
    ...
    return distanceSq <= radSqr -- return true or false
end